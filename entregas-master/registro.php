                ...
                <fieldset>
                    <div>
                        <input placeholder="Documento" name="documento" type="number" required="required" autofocus
                               value=<?php if(isset($_SESSION['documento'])) echo "\"".$_SESSION['documento']."\""; unset($_SESSION['documento']) ?>  >
                        <div> </div>
                    </div>
                    <div>
                        <input placeholder="Nombres" name="nombre" type="text"   required="required" value="">
                        <div>  </div>
                    </div>
                    <div>
                        <input placeholder="Apellidos" name="apellidos" type="text"  required="required" value="" >
                        <div> </div>
                    </div>
                    <div>
                        <input id="InputCorreo" placeholder="Correo Electrónico" name="email" type="email"  required="required" value="" >
                        <div> </div>
                    </div>
                    <div>
